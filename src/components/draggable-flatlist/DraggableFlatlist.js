...
class SortableFlatList extends React.Component {
        ...
        this._panResponder = PanResponder.create({
            onStartShouldSetPanResponderCapture: (evt, gestureState) => {
                ...
                this._additionalOffset =
                    tappedPixel +
                    this._scrollOffset -
                    this._measurements[tappedRow][horizontal ? 'x' : 'y'];
                ...
                if (Platform.OS === 'android' && !horizontal) {
                    ...
                    this._androidStatusBarOffset =
                        isTranslucent || isHidden ? StatusBar.currentHeight : 0;
                }
            ...
            onPanResponderRelease: () => {
                ...
                const activeItemSize = horizontal
    ...
    animate = () => {
        ...
        if (this._measurements[activeRow]) {
            ...
            const hoverItemBottomPosition = Math.min(
                this._containerSize,
                hoverItemTopPosition + rowSize
            );
