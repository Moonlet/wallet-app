...
export class ReviewMessageComponent extends React.Component<
            ...
            <View style={styles.container}>
                ...
                <View style={{ flex: 1 }}>
                    <Text style={styles.primaryText}>
                        {translate('LedgerConnect.reviewMessage')}
                    </Text>

                    <Text style={styles.secondaryText}>
                        {translate('LedgerConnect.reviewMessageDevice', {
...
export const ReviewMessage = smartConnect<IExternalProps>(ReviewMessageComponent, [
