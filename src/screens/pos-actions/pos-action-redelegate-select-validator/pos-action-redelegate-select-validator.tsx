...
export class PosActionRedelegateSelectValidatorComponent extends React.Component<
...
export const PosActionRedelegateSelectValidator = smartConnect(
    PosActionRedelegateSelectValidatorComponent,
    [
