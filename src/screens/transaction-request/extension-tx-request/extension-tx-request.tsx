...
const renderTransferTransaction = (props: IProps) => {
    ...
    const displayAmount = blockchainInstance.account
        .amountFromStd(
            new BigNumber(blockchainInstance.transaction.getTransactionAmount(tx)),
        ...
        case NotificationType.MOONLET_TRANSACTION:
            ...
            switch (tx?.type) {
                ...
                default:
                    ...
                    return <Text style={{ color: 'white' }}>UNSUPPORTED({tx?.type})</Text>;
            }
            break;
        default:
            ...
            return (
                <Text style={{ color: 'white' }}>
                    UNSUPPORTED({props.extensionTxPayload?.method})
                </Text>
            );
    }
